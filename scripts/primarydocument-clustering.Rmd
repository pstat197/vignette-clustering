...
We have thus performed hierarchical clustering on the sample of 50 observations from the original `wine2` dataset. We now perform hierarchical clustering on the whole `wine2` dataset in the chunk below. We test various linkage methods and select
