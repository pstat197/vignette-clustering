...
kmeans2 <- kmeans(wine_cut, centers = 2, nstart = 30)
str(kmeans2)
```
...
fviz_cluster(kmeans2, data = wine_cut)

```

```{r}
kmeans3 <- kmeans(wine_cut, centers = 3, nstart = 30)
kmeans4 <- kmeans(wine_cut, centers = 4, nstart = 30)
kmeans5 <- kmeans(wine_cut, centers = 5, nstart = 30)

# plots to compare
p1 <- fviz_cluster(kmeans2, geom = "point", data = wine_cut) + ggtitle("k = 2")
p2 <- fviz_cluster(kmeans3, geom = "point",  data = wine_cut) + ggtitle("k = 3")
p3 <- fviz_cluster(kmeans4, geom = "point",  data = wine_cut) + ggtitle("k = 4")
p4 <- fviz_cluster(kmeans5, geom = "point",  data = wine_cut) + ggtitle("k = 5")
...
#ELBOW
fviz_nbclust(wine_cut, kmeans, method = "wss")
#SILHOUETTE
fviz_nbclust(wine_cut, kmeans,method = "silhouette")
#GAP STATISTICS

gap_stat <- clusGap(wine_cut, FUN = kmeans, nstart = 30,
                    K.max = 10, B = 50)
